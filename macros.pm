...
if ($dataString =~ m/$transferCmd=([^=]+)/ ) {
  ...
  for my $byte (@rawData) {
    my $scaledVoltage =$byte/255*$screenHeightVoltage-$traceOffsetVoltage;
